...
document.querySelector('.text-features h3').textContent = "Feature " + currentFeature;
document.querySelector('.text-features p').textContent = textContent;
}

document.addEventListener('DOMContentLoaded', function() {
document.querySelector('.arrow').addEventListener('click', nextFeature);
});
